...
public class Loto {
    ...
    public static void main(String[] args) {
        ...
        switch (korisnickiUnos.nextInt()){
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("Koliko brojeva zelite izvuci? ");
                int brojevaZaIzvuci = korisnickiUnos.nextInt();
                System.out.println("Od koliko mogucih? ");
    ...
    private static void ispisiNaslovIgre(int brojeva, int odMax){
        System.out.println("Igra loto "+ brojeva + " od " +  odMax + " zapocinje !! \nA izvuceni brojevi su:");
    }
    ...
    private static void ispisiPozdravnuPoruku() {
        System.out.println("\nHvala vam sto ste se igrali s nama i nadama se da ste nesto i osvojili.");
    }
}
